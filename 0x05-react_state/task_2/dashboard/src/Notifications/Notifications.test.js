...
describe("Notifications", () => {
  ...
  test("clicking on the menu item calls handleDisplayDrawer", () => {
    ...
    const wrapperWithMock = shallow(
      <Notifications handleDisplayDrawer={handleDisplayDrawer} />
    );
    wrapperWithMock.find("#menuItem").simulate("click");
  ...
  test("clicking on the button calls handleHideDrawer", () => {
    ...
    wrapperWithMock.find("#closeNotifications").simulate("click");
    expect(handleHideDrawer).toHaveBeenCalled();
  });
});

describe("Testing Notification when displayDrawer is true and listNotifications contains objects", () => {
  let wrapper;
  ...
  test("renders `Here is the list of notifications` when array is not empty", () => {
